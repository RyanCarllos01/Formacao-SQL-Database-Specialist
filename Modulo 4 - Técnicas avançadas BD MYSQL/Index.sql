...
CREATE TABLE customer ( 
	...
	KEY idx_fk_store_id (store_id),  -- pra definir indices tem que usar a palavra key
...
create table exemplo(
    ...
    email varchar(50)
) engine = MEMORY; -- pra usar o tipo de estruturação hash invés do Btree do innodb
